...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        albumRVAdapter.setMyItemClickListener(object : AlbumRVAdapter.MyItemClickListener{
            ...
            override fun onPlayBtnClick(titleItem: TitleItem) {
                requireActivity().findViewById<TextView>(R.id.mainMiniplayerTitleTv).text = titleItem.firstTitle
                requireActivity().findViewById<TextView>(R.id.mainMiniplayerSingerTv).text = titleItem.firstSinger
            }
        })
